...
resource "aws_route_table_association" "opstree_eks_route_table_association" {
  count          = var.eks_subnet_ids_count
  subnet_id      = element(var.eks_subnet_ids, count.index)
